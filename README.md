...
An interactive Python desktop visualization software for exploring classic biological interaction models, based on **Otto & Day (Chapter 3: *Models of Interactions among Species*)**.
...
- **Dynamic Parameter & Scenario Panel:**
  ...
  - Continuous ODE solving (adaptive **Runge-Kutta RK45** and **LSODA**) and discrete-time recursion (Eq 3.14).
...
### 1. Lotka-Volterra Model of Competition & Species Interactions (Section 3.4.1)
...
Also supports the discrete-time recursion version (Equations 3.14a,b):
...
### 2. Consumer-Resource Models (Section 3.4.2 & Table 3.3)
$$\frac{dn_1}{dt} = f(n_1) - g(n_1, n_2)$$
$$\frac{dn_2}{dt} = \varepsilon \, g(n_1, n_2) - h(n_2)$$

Modular components from Table 3.3:
...
#### Named Presets from the Text:
- **Nutrient Inflow / Chemostat (Eq 3.17):**
