    ...
    def param_meta(self) -> Dict[str, Dict[str, Any]]:
        return {
            ...
            "K1": {
                ...
                "max": 1000.0,
                "step": 5.0,
                "description": "Carrying capacity of species 1",
            },
            "K2": {
                ...
                "max": 1000.0,
                "step": 5.0,
                "description": "Carrying capacity of species 2",
            },
            "alpha12": {
...
class ConsumerResourceModel(BiologicalModel):
    ...
    def param_meta(self) -> Dict[str, Dict[str, Any]]:
        return {
            ...
            "K": {"label": "K (Carrying capacity)", "min": 5.0, "max": 1000.0, "step": 5.0, "description": "Environmental carrying capacity for resource"},
